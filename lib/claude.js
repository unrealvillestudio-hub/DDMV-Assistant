...
Hora actual en Panamá (Damaris): ${datePA} ${timePA}
Hora actual en ${caregiverTzLabel} (${userName}): ${dateCG} ${timeCG}

Cuando ${userName} diga "en X minutos", "mañana a las Yh", "a las Z" — usa SIEMPRE su hora en ${caregiverTzLabel}, no la de Panamá.
Convierte correctamente al guardar recordatorios en ISO 8601.
